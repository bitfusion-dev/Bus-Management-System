...
document
  .querySelector("#bus-timings tbody")
  .addEventListener("click", function (e) {
    if (
      e.target.classList.contains("remove-btn") ||
      e.target.closest("button").classList.contains("remove-btn")
    ) {
...
document
  .getElementById("lost-found-form")
  .addEventListener("submit", function (e) {
    e.preventDefault();
...
function searchRoutes() {
  ...
  let routes = document
    .getElementById("bus-routes-list")
...
document
  .querySelector("#crew-list tbody")
  .addEventListener("click", function (e) {
    if (
      e.target.classList.contains("remove-crew-btn") ||
      e.target.closest("button").classList.contains("remove-crew-btn")
    ) {
      e.target.closest("tr").remove(); // Remove the corresponding row
    }
  });
...
document
  ...
  .addEventListener("submit", function (e) {
    ...
    const emergencyDescription = document.getElementById(
